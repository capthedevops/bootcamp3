package com.hosep.sample.api.rest;

import com.hosep.sample.domain.User;
import com.hosep.sample.exception.DataFormatException;
import com.hosep.sample.service.UserService;
...
@RestController
@RequestMapping(value = "/sample/v1/users")
@Api(value = "usres", description = "User API")
